...
NUM_CLASSES = 1
PATH_TO_SAVE_IMG = '/media/maciej/Thyroid/thyroid-nodules/detection-baseline/Nodules-cv-bboxes'
PATH_TO_SAVE_CSV = '/media/maciej/Thyroid/thyroid-nodules/detection-baseline/Calipers-cv'
...
for f in range(10):
	FOLD = f
	PATH_TO_CKPT = '/media/maciej/Thyroid/thyroid-nodules/detection-baseline/{}/model/inference/frozen_inference_graph.pb'.format(FOLD)
