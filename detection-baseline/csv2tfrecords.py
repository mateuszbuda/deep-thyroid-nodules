...
flags.DEFINE_string(
    "train_record",
    "/media/maciej/Thyroid/thyroid-nodules/detection-baseline/{}/data/train.record".format(
        fold
    ),
...
flags.DEFINE_string(
    "test_record",
    "/media/maciej/Thyroid/thyroid-nodules/detection-baseline/{}/data/valid.record".format(
        fold
    ),
