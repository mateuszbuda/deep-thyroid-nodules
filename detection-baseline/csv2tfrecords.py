...
flags.DEFINE_string('train_record',
                    '/media/maciej/Thyroid/thyroid-nodules/detection-baseline/{}/data/train.record'.format(fold),
                    'Path to output train TFRecord')
flags.DEFINE_string('test_record',
                    '/media/maciej/Thyroid/thyroid-nodules/detection-baseline/{}/data/valid.record'.format(fold),
...
def main(_):
	...
	pid_set = set()  # set of unique patient ids used for patient based train/validation split
