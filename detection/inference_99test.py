...
PATH_TO_CKPT = '/media/maciej/Thyroid/thyroid-nodules/detection/test/model/inference/frozen_inference_graph.pb'
...
TEST_IMAGE_PATHS = glob('/media/maciej/Thyroid/thyroid-nodules/detection/Nodules-test/*.PNG')
